...
export const learningGuides = [
  ...
  { slug: "play-3d-audio-godot", title: "How to Play 3D Audio and Music in Godot", shortTitle: "3D Audio and Music", description: "Set up positional sound, ambience, music, distance falloff, and event-driven playback without tangled scene scripts.", image: "/docs/thumbs/audio.png" },
  { slug: "switch-cameras-godot", title: "How to Switch Cameras in Godot", shortTitle: "Switch Cameras", description: "Move cleanly between player, fixed, and cutscene cameras while preserving input and returning control safely.", image: "/docs/thumbs/cameras.png" },
  { slug: "change-scenes-load-levels-godot", title: "How to Change Scenes and Load Levels in Godot", shortTitle: "Change Scenes and Load Levels", description: "Choose between full level changes and streamed sub-scenes, then handle transitions, cleanup, and player control.", image: "/docs/thumbs/sub-scene.png" },
  { slug: "blender-godot-import-troubleshooting", title: "How to Fix Blender-to-Godot Import Problems", shortTitle: "Fix Blender-to-Godot Imports", description: "Diagnose missing metadata, wrong transforms, stale imports, silent audio, inactive triggers, and broken scene paths.", image: "/docs/thumbs/troubleshooting.png" },
